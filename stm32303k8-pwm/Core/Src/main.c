...
int main(void)
{
  ...
  fader1 = new PWMFader(&htim1, TIM_CHANNEL_1, 2000);  // 2 second cycle
  fader2 = new PWMFader(&htim1, TIM_CHANNEL_2, 2000);  // 2 second cycle
  fader3 = new PWMFader(&htim1, TIM_CHANNEL_3, 200);   // 200ms cycle
  fader4 = new PWMFader(&htim1, TIM_CHANNEL_4, 200);   // 200ms cycle
